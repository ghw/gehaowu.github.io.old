 ...
 * https://yevhentiurin.github.com/photocradle/
 *
...
$.photocradle.service.picasa = function ( params, loadHandler ) {
  ...
  $.getJSON( [ 'https://picasaweb.google.com/data/feed/api/user/', picasaParams.user, '/albumid/', picasaParams.album ].join( '' ), { alt: 'json' }, function( data ) {
    if ( !data.feed )
      return;
