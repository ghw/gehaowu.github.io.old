...
OverlayLoader.prototype.createOverlay = function () {
	...
	if (this.parent.options.percentage == true) {
		this.percentageContainer = $("<div id='qLpercentage'></div><div class='loading-image-holder'><div class='image-block animLoader'></div></div>").css({
			height: "23px",
			width: "65px",
			position: "absolute",
			top: "0",
...
OverlayLoader.prototype.updatePercentage = function (percentage) {
	...
	if (this.parent.options.percentage == true) {
		var prc = Math.ceil(percentage) + "%";
		this.percentageContainer.parent().find('div.loading-image-holder div.image-block').css({'width':prc,'z-index':600});
	}
};
